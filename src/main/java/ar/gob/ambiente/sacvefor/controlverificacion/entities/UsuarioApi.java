 ...
 * (CGL y TRAZ). Estos usuarios serán los que inserten o editen entidades locales desde la API
 * @author rincostante
 */
@Entity
public class UsuarioApi implements Serializable {
     ...
     * es decir, a qué cliente pertenece Ej: CLIENTE_CGL, CLIENTE_TRAZ, etc.
     */
    @ManyToOne
